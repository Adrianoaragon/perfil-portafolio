export function createDom() {
  const elements = {
    ...
    profileLocText: document.getElementById('profile-loc-text'),
    ...
    actImgsWrap:    document.querySelector('.activity-imgs'),
    socialsRow:     document.getElementById('socials-row'),
    musicPlayer:    document.getElementById('music-player'),
    musicCoverWrap: document.getElementById('music-cover-wrap'),
